    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="p-4 max-w-4xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-3 gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {todayStatus === 'checked_out' ? 'Checked Out' : 
                     todayStatus === 'checked_in' ? 'Checked In' : 'Not Checked'}
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          <Card className={`col-span-3 sm:col-span-1 ${approvedLeavesThisMonth >= 3 ? 'border-warning' : ''}`}>
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                <Calendar className={`h-8 w-8 ${approvedLeavesThisMonth >= 3 ? 'text-warning' : 'text-green-500'}`} />
                <div>
                  <p className="text-xs text-muted-foreground">Leaves This Month</p>
                  <p className="font-semibold text-xl">{approvedLeavesThisMonth} / 3</p>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-xl">₹{balance.toLocaleString('en-IN')}</p>
                </div>
              </div>
            </CardContent>
          </Card>
